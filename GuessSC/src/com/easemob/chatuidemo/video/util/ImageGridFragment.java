...
import com.cdrongyao.caisichuan.BuildConfig;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		tvBack = (TextView) v.findViewById(R.id.navigation_tv_back);
		tvTitle = (TextView) v.findViewById(R.id.navigation_tv_title);
