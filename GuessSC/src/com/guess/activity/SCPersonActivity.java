...
public class SCPersonActivity extends Activity implements OnClickListener, IXListViewListener {
	...
	// "http://api.caisichuan.com/api/v2/city/getQuestions";//获取题目列表(点击开始之后)
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (msg.what == 0) {
				...
				ArrayList<HashMap<String, Object>> list = getSubList(sqlList, mDataList.size(),
						mDataList.size() + Integer.parseInt(NUMBER));
